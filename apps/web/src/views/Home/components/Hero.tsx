      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="secondary" mb="24px">
            {t('Plaxswap is new DEX on Polygon.')}
          </Heading>
          <Heading scale="md" mb="24px">
            {t('Trade, earn, and win crypto on the most popular decentralized platform in the polygon galaxy.')}
          </Heading>
          <Flex>
        ...
        >
          <BunnyWrapper>
            <Image
              src={`${ASSET_CDN}/images/astronaut-bunny.png`}
              priority
              // https://blurred.dev/
